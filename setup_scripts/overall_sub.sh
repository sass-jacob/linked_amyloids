...
~/md_proteins/production_scripts/prod_sub.sh "$input_file_prod"

# submit the autoimage script
input_traj_autoimage="~/md_proteins/${dir_name}/${linker_name}_traj.dcd"
output_traj_autoimage="~/md_proteins/${dir_name}/${linker_name}_autoimage.pdb"
